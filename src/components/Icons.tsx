...
export const WhatsappIcon = ({ size = 24, className = "" }: { size?: number, className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-14.7 8.38 8.38 0 0 1 3.8.9L21 3.5Z" />
    <path d="M11 16c1.2.9 2.8 1.1 4 .5l1-1.5" />
    <path d="M8.5 12c1.2.9 2.8 1.1 4 .5l1-1.5" />
  </svg>
);
